...
* Check your MSU email for an automatically generated email from Omeka.
  ...
  * Some phone apps filter out Omeka emails; check on a laptop or desktop computer instead of a mobile device if possible. <br><br><img style="border:1px solid black" class="center" src="img/logging-into-omeka/omeka_login_1.png" width="60%"><br><br>
