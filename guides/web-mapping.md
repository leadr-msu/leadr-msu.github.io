...
- [Carto](https://leadr-msu.github.io/hst251-geospatialdata/): service that provides GIS, web mapping and spatial data science tools. Many tools do not require experience with data analysis/visualization or GIS.
...
- ArcGIS: widely used GIS platform service used for geospatial analysis. There is both a [desktop](https://desktop.arcgis.com/en/) and [online](https://www.arcgis.com/index.html) version.
...
## Geospatial Data
Geospatial data is data which provides location data in addition to metadata describing why particular locations are important. Geospatial data can come in a variety of formats, including lat/long data in an excel file, geojson files, and .kml files. Before you begin creating a web map, you will have to think about what your data means.

### Questions to Ask your Data
Here's a list of questions to ask about your data when making a map.
...
- **What types of bias are present in the data?** Turn a critical eye towards what you have. Geospatial data are subject to bias like any other type of data.
...
Once you have found a meaningful pattern in your data, you can start making your map. Use the available geospatial data for your pattern to create an interactive map in any web mapping software to visualize your story.
