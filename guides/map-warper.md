...
6. You now have a georectified image that can be exported in a number of ways for a number of purposes. Check out the **Exports** tab for various formats of your new georectified image (including KML). Alternatively, some applications (like [Neatline](https://leadr-msu.github.io/guides/neatline/)) allow you to refer directly to a WMS URL for your georectified image.
  * The WMS address will be http://mapwarper.net/maps/wms/39213, except your the last 5 numbers will be the identifying number of your map (the identifying number can be found in the url when you are at your map's page in mapwarper.net)
