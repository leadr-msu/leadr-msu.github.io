...
4. Upload the image that you want to georectify by clicking the **Choose File** button or by referring to the images url if it is on the web. <br><br><img style="border:1px solid black" class="center" src="img/map-warper/map_warper_2.png" width="80%"><br><br>
5. Click the **Create button** to combine your map image and metadata into Map Warper. <br><br><img style="border:1px solid black" class="center" src="img/map-warper/map_warper_3.png" width="80%"><br><br>
